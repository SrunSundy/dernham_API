...
class UploadRestController extends REST_Controller{	
	...
	function upload_feedback_photo_temp_post(){
		$response = array();
		...
		$request_upload["image_file"] = $_FILES;
		$upload_target = UPLOAD_FILE_PATH ."/uploadimages/temp/user_feedback/";
		$response_data = $this->UploadModel->uploadUserFeedbackImage($request_upload, $upload_target);
