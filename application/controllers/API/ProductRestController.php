...
class ProductRestController extends REST_Controller{
  ...
  public function get_product_detail_post(){
    ...
    if(count($product_detail) > 0){
        ...
        if($product_detail[0]->shop_phone){
          $product_detail[0]->shop_phone = explode("|", $product_detail[0]->shop_phone);
        }
  ...
  public function list_recommended_product_get(){
      ...
      $responsequery = $this->ProductModel->listRecommendedProduct($request);
